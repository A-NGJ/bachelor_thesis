...
class WamvEnv(robot_gazebo_env.RobotGazeboEnv):
    ...
    def __init__(self, ros_ws_abspath):
        ...
        * /cmd_drive: You publish the speed of the left and right propellers.
        ...
        rospy.Subscriber(self.FRONT_CAMERA, Image, self._image_callback)


        self.publishers_array = []
        self._cmd_drive_left = rospy.Publisher('/wamv/thrusters/left_thrust_cmd', Float32, queue_size=1)
        self._cmd_drive_right = rospy.Publisher('/wamv/thrusters/right_thrust_cmd', Float32, queue_size=1)
    ...
    def _check_all_systems_ready(self):
        ...
        # self._check_front_camera_ready()
    ...
    def _check_front_camera_ready(self):
        ...
        while self.image is None and not rospy.is_shutdown():
            try:
                self.image = rospy.wait_for_message(self.FRONT_CAMERA, Image, timeout=5.0)
